...
struct StringMacros
{
  ...
  public:
	...
	static void 				extractCommonChunks			(const std::vector<std::string>& haystack, std::vector<std::string>& commonChunksToReturn, std::set<std::string>& wildcardStrings, unsigned int& fixedWildcardLength);
