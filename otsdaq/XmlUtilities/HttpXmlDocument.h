...
class HttpXmlDocument : public XmlDocument
{
  public:
	...
	void 		      setHeader                       (      std::string                         cookieCode     = "",
                                                                     std::string                         displayName    = ""    );
	xercesc::DOMElement * getRootDataElement              (void                                                             ) { return dataElement_; }
	xercesc::DOMElement * addTextElementToData            (const std::string                       & field, 
                                                               const std::string                       & value          = ""    );
	xercesc::DOMElement * addBinaryStringToData           (const std::string                       & field, 
                                                               const std::string                       & binary                 );
	void 		      copyDataChildren                (      HttpXmlDocument                   & document               );
	std::string 	      getMatchingValue                (const std::string                       & field, 
                                                               const unsigned int                        occurance      = 0     );
	void 		      getAllMatchingValues            (const std::string                       & field, 
                                                                     std::vector<std::string>          & retVec);
	xercesc::DOMElement * getMatchingElement              (const std::string                       & field,
                                                               const unsigned int                        occurance      = 0     );
	xercesc::DOMElement * getMatchingElementInSubtree     (      xercesc::DOMElement               * currEl, 
                                                               const std::string                       & field, 
                                                               const unsigned int                        occurance      = 0     );
	void                  getAllMatchingElements          (const std::string                       & field, 
  ...
  private:
	void 		      recursiveAddElementToParent     (      xercesc::DOMElement               * child                   ,
	...
	std::string           recursiveFindElementValue       (      xercesc::DOMElement               * currEl                  ,
	                                                       const std::string                       & field                   ,
	                                                       const unsigned int                        occurance               ,
	                                                             unsigned int                      & count                  );
	xercesc::DOMElement * recursiveFindElement            (      xercesc::DOMElement               * currEl                  ,
			                                       const std::string                       & field                   ,
			                                       const unsigned int                        occurance               ,
			                                             unsigned int                      & count                  );
