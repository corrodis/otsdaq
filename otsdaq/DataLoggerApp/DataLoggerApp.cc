...
void DataLoggerApp::init(void)
{
	std::cout << __COUT_HDR_FL__
	          << "ARTDAQDataLogger SUPERVISOR INIT!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
	          << std::endl;
	...
	std::cout << __COUT_HDR_FL__
	          << "ARTDAQDataLogger SUPERVISOR INIT4!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
	          << std::endl;
...
{
	std::cout << __COUT_HDR_FL__
	          << "ARTDAQDataLogger SUPERVISOR CONFIGURING!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
	          << std::endl;
	std::cout << __COUT_HDR_FL__
	...
	// "daq:{DataLogger:{event_builder_count:2 event_queue_depth:20
	...
	//    std::string configString = "daq:{DataLogger:{event_builder_count:1
...
void DataLoggerApp::transitionStarting(toolbox::Event::Reference e)
{
	...
	{
		std::cerr << "Error parsing string to art::RunNumber_t: " << runnumber
		          << std::endl;
		exit(1);
	}
}
