...
//========================================================================================================================
DataLoggerApp::~DataLoggerApp(void) { destroy(); }
//========================================================================================================================
...
//========================================================================================================================
void DataLoggerApp::destroy(void) { theDataLoggerInterface_.reset(nullptr); }
...
void DataLoggerApp::transitionConfiguring(toolbox::Event::Reference e) {
  ...
  // configuration  std::string configString = "daq:{DataLogger:{event_builder_count:2 event_queue_depth:20
  // event_queue_wait_time:5 expected_events_per_bunch:1 file_duration:0 file_event_count:0 file_size_MB:0
  // first_event_builder_rank:2 mpi_buffer_count:8 print_event_store_stats:true
  ...
  // outputs:{normalOutput:{fileName:\"/data/otsdata/data/artdaqots_r%06r_sr%02s_%to.root\" module_type:\"RootOutput\"}}
  // physics:{my_output_modules:[\"normalOutput\"] p2:[\"BuildInfo\"] producers:{BuildInfo:{instance_name:\"ArtdaqOts\"
  // module_type:\"ArtdaqOtsBuildInfo\"}}} process_name:\"DAQAG\" services:{Timing:{summaryOnly:true}
  // scheduler:{fileMode:\"NOMERGE\"} user:{NetMonTransportServiceInterface:{max_fragment_size_words:2.097152e6
  // service_provider:\"NetMonTransportService\"}}} source:{module_type:\"NetMonInput\"}";  ONLY 1 BOARD READER
  //    std::string configString = "daq:{DataLogger:{event_builder_count:1 event_queue_depth:20 event_queue_wait_time:5
  //    expected_events_per_bunch:1 file_duration:0 file_event_count:0 file_size_MB:0 first_event_builder_rank:1
  ...
  //    max_fragment_size_words:2.097152e6} outputs:{normalOutput:{fileName:\""+path+"artdaqots_r%06r_sr%02s_%to.root\"
  //    module_type:\"RootOutput\"}} physics:{my_output_modules:[\"normalOutput\"] p2:[\"BuildInfo\"] a1:[\"wf\"]
  //    producers:{BuildInfo:{instance_name:\"ArtdaqOts\" module_type:\"ArtdaqOtsBuildInfo\"}} analyzers:{wf:
  //    {module_type:\"WFViewer\" fragment_ids:[0] fragment_type_labels:[ \"DataGen\" ] prescale:60 write_to_file:true
  //    fileName:\""+path+"otsdaqdemo_onmon.root\"}}} process_name:\"DAQAG\" services:{Timing:{summaryOnly:true}
  //    scheduler:{fileMode:\"NOMERGE\" errorOnFailureToPut: false}
  //    NetMonTransportServiceInterface:{max_fragment_size_words:2097152 service_provider:\"NetMonTransportService\"}}
  ...
  TLOG(TLVL_INFO, "DataLoggerInterface")
...
//========================================================================================================================
void DataLoggerApp::transitionInitializing(toolbox::Event::Reference e) { init(); }

//========================================================================================================================
void DataLoggerApp::transitionPausing(toolbox::Event::Reference e) { theDataLoggerInterface_->pause(0, 0); }

//========================================================================================================================
void DataLoggerApp::transitionResuming(toolbox::Event::Reference e) { theDataLoggerInterface_->resume(0, 0); }
...
//========================================================================================================================
void DataLoggerApp::transitionStopping(toolbox::Event::Reference e) { theDataLoggerInterface_->stop(0, 0); }
