#ifndef _CodeEditor_version_h_
#define _CodeEditor_version_h_
...
const std::string package  = "CodeEditor";
const std::string versions = MYPACKAGE_FULL_VERSION_LIST;
const std::string summary  = "CodeEditor otsdaq supervisor base class";
const std::string description =
    "Used for CodeEditor supervisor functionality including configuration and state "
    "transitions.";
