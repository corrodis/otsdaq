...
// ARTDAQProducer
//	This class is a Data Producer Plugin that allows a single artdaq Event Builder to be instantiate as a Producer
//to an otsdaq Buffer.
class ARTDAQProducer : public DataProducer, public Configurable {
 public:
  ARTDAQProducer(std::string supervisorApplicationUID, std::string bufferUID, std::string processorUID,
