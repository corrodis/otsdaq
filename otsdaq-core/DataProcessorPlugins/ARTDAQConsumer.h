...
// ARTDAQConsumer
//	This class is a Data Consumer Plugin that allows a single artdaq Event Builder to be instantiate as a Consumer
//to an otsdaq Buffer.
class ARTDAQConsumer : public DataConsumer, public Configurable {
 public:
  ARTDAQConsumer(std::string supervisorApplicationUID, std::string bufferUID, std::string processorUID,
