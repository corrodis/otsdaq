...
//========================================================================================================================
RawDataVisualizerConsumer::RawDataVisualizerConsumer(std::string supervisorApplicationUID, std::string bufferUID,
...
bool RawDataVisualizerConsumer::workLoopThread(toolbox::task::WorkLoop* workLoop) {
  __COUT__ << DataProcessor::processorUID_ << " running, because workloop: " << WorkLoop::continueWorkLoop_
           << std::endl;
  slowRead();  // fastRead();
