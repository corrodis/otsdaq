...
// If you are planning on specializing any methods you should inherit from RawDataSaverConsumerBase the same way this
// consumer is doing.
...
class RawDataSaverConsumer : public RawDataSaverConsumerBase {
 public:
  RawDataSaverConsumer(std::string supervisorApplicationUID, std::string bufferUID, std::string processorUID,
