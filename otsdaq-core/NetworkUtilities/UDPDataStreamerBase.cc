...
//========================================================================================================================
UDPDataStreamerBase::UDPDataStreamerBase(std::string IPAddress, unsigned int port, std::string toIPAddress,
                                         unsigned int toPort)
    : TransmitterSocket(IPAddress, port), streamToSocket_(toIPAddress, toPort) {
