...
class FEVInterfacesManager : public VStateMachine, public Configurable {
 public:
  FEVInterfacesManager(const ConfigurationTree& theXDAQContextConfigTree,
  ...
  void runFEMacro(const std::string& interfaceID, const FEVInterface::frontEndMacroStruct_t& feMacro,
                  const std::string& inputArgs,
                  std::string& outputArgs);  // used by MacroMaker and FE calling indirectly
  void runFEMacro(const std::string& interfaceID, const std::string& feMacroName, const std::string& inputArgs,
                  std::string& outputArgs);  // used by MacroMaker
  void runFEMacroByFE(const std::string& callingInterfaceID, const std::string& interfaceID,
                      const std::string& feMacroName, const std::string& inputArgs,
                      std::string& outputArgs);  // used by FE calling (i.e. FESupervisor)
  void startFEMacroMultiDimensional(const std::string& requester, const std::string& interfaceID,
                                    const std::string& feMacroName, const bool enableSavingOutput,
                                    const std::string& outputFilePath, const std::string& outputFileRadix,
                                    const std::string& inputArgs);  // used by iterator calling (i.e. FESupervisor)
  void startMacroMultiDimensional(const std::string& requester, const std::string& interfaceID,
  ...
  const std::map<std::string /*name*/, std::unique_ptr<FEVInterface> >& getFEInterfaces(void) const {
