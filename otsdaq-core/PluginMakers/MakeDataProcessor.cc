...
ots::DataProcessor* ots::makeDataProcessor(
    std::string const& processorPluginName, std::string const& supervisorApplicationUID, std::string const& bufferUID, std::string const& processorUID, ots::ConfigurationTree const& configurationTree, std::string const& pathToInterfaceConfiguration)
{
