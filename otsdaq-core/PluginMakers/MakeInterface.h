...
std::unique_ptr<FEVInterface> makeInterface(
    const std::string& interfacePluginName, const std::string& interfaceUID, const ConfigurationTree& configurationTree, const std::string& pathToInterfaceConfiguration);
}  // namespace ots
