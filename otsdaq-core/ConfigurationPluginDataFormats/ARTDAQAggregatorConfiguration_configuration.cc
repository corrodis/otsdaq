...
//========================================================================================================================
std::string ARTDAQAggregatorConfiguration::getFHICLFilename(
...
//========================================================================================================================
void ARTDAQAggregatorConfiguration::outputFHICL(
			...
			try
			{
				...
				for(auto& source : sources)
				{
					...
					OUT << source.second.getNode("sourceKey").getValue() << ": {"
					    ...
					    << source.second
					           .getNode(
					               "ARTDAQGlobalConfigurationLink/maxFragmentSizeWords")
