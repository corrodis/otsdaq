...
: ConfigurationBase("UDPDataStreamerConsumerConfiguration")
{
	...
	//	  <CONFIGURATION Name="UDPDataStreamerConsumerConfiguration">
	...
	//	      <COLUMN Name="StreamToIPAddress" StorageName="STREAM_TO_IP_ADDRESS" DataType="VARCHAR2"/>
	//	      <COLUMN Name="StreamToPort"      StorageName="STREAM_TO_PORT"       DataType="NUMBER"  />
	//	    </VIEW>
	//	  </CONFIGURATION>
	//	</ROOT>
