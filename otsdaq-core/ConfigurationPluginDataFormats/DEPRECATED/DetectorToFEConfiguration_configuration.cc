...
//==============================================================================
DetectorToFEConfiguration::DetectorToFEConfiguration(void) : ConfigurationBase("DetectorToFEConfiguration") {
  //////////////////////////////////////////////////////////////////////
...
void DetectorToFEConfiguration::init(ConfigurationManager* configManager) {
  ...
  for (unsigned int row = 0; row < ConfigurationBase::activeConfigurationView_->getNumberOfRows(); row++) {
    ...
    ConfigurationBase::activeConfigurationView_->getValue(aDetectorInfo.theFEWriterDetectorAddress_, row,
    ...
    ConfigurationBase::activeConfigurationView_->getValue(aDetectorInfo.theFEReaderDetectorAddress_, row,
