...
//==============================================================================
DetectorConfiguration::DetectorConfiguration(void) : ConfigurationBase("DetectorConfiguration") {
  //////////////////////////////////////////////////////////////////////
...
void DetectorConfiguration::init(ConfigurationManager* configManager) {
  ...
  for (auto& it : detectorTypes) detectorTypes_.push_back(it.first);
}

//==============================================================================
const std::vector<std::string>& DetectorConfiguration::getDetectorIDs() const { return detectorIDs_; }

//==============================================================================
const std::vector<std::string>& DetectorConfiguration::getDetectorTypes() const { return detectorTypes_; }
