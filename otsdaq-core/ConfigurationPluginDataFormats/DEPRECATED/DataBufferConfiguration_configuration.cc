...
//==============================================================================
DataBufferConfiguration::DataBufferConfiguration(void) : ConfigurationBase("DataBufferConfiguration") {
  //////////////////////////////////////////////////////////////////////
...
std::vector<std::string> DataBufferConfiguration::getProcessorIDList(std::string dataBufferID) const {
  ...
  for (auto const& it : processorInfos_.find(dataBufferID)->second.processors_) list.push_back(it.first);
  return list;
}
...
std::vector<std::string> DataBufferConfiguration::getProducerIDList(std::string dataBufferID) const {
  std::vector<std::string> list;
  for (auto const& it : processorInfos_.find(dataBufferID)->second.producers_) list.push_back(it.first);
  return list;
}
...
std::vector<std::string> DataBufferConfiguration::getConsumerIDList(std::string dataBufferID) const {
  std::vector<std::string> list;
  for (auto& it : processorInfos_.find(dataBufferID)->second.consumers_) list.push_back(it.first);
  return list;
}
