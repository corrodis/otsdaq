...
class FEConfiguration : public ConfigurationBase {
 public:
  ...
  // Getters
  //	std::vector<std::string>  getListOfFEIDs       (void) const; 	std::vector<std::string>  getListOfFEIDs
  //(const std::string& supervisorType, unsigned int supervisorInstance)                                const;
  //	//FIXME This is wrong because there can be same name interfaces on different supervisors!!!!!!! I am doing it
  //for the DQM :( 	const std::string         getFEInterfaceType   (const std::string& frontEndID)
  //const; 	const std::string         getFEInterfaceType   (const std::string& supervisorType, unsigned int
 ...
 private:
  enum { SupervisorType, SupervisorInstance, FrontEndId, FrontEndType };
  std::string composeUniqueName(std::string supervisorName, unsigned int supervisorInstance) const {
