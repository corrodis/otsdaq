...
//==============================================================================
FEConfiguration::FEConfiguration(void) : ConfigurationBase("FEConfiguration") {
  //////////////////////////////////////////////////////////////////////
...
//
////==============================================================================
// std::vector<std::string> FEConfiguration::getListOfFEIDs(const std::string& supervisorType, unsigned int
...
//				return
//ConfigurationBase::getView().getDataView()[typeNameToRow_.find(itSupervisors.first)->second.find(frontEndID)->second][FrontEndType];
...
//
////==============================================================================
// const std::string FEConfiguration::getFEInterfaceType(const std::string& supervisorType, unsigned int
...
//
//	return
//ConfigurationBase::getView().getDataView()[typeNameToRow_.find(uniqueName)->second.find(frontEndID)->second][FrontEndType];
//}
