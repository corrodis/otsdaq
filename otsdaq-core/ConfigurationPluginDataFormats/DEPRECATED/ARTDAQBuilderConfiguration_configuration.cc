...
std::string ARTDAQBuilderConfiguration::getAggregatorID(unsigned int supervisorInstance) const {
  ...
  ConfigurationBase::activeConfigurationView_->getValue(
      tmpID, ConfigurationBase::activeConfigurationView_->findRow(SupervisorInstance, supervisorInstance), BuilderID);
  return tmpID;
}
...
bool ARTDAQBuilderConfiguration::getStatus(unsigned int supervisorInstance) const {
  bool tmpStatus;
  ConfigurationBase::activeConfigurationView_->getValue(
      tmpStatus, ConfigurationBase::activeConfigurationView_->findRow(SupervisorInstance, supervisorInstance), Status);
  return tmpStatus;
}
...
const std::string ARTDAQBuilderConfiguration::getConfigurationString(unsigned int supervisorInstance) const {
  ...
  ConfigurationBase::activeConfigurationView_->getValue(
      tmpConfiguration, ConfigurationBase::activeConfigurationView_->findRow(SupervisorInstance, supervisorInstance),
      ConfigurationString);
