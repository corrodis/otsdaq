...
//==============================================================================
ARTDAQConsumerConfiguration::ARTDAQConsumerConfiguration(void) : ConfigurationBase("ARTDAQConsumerConfiguration") {
  //////////////////////////////////////////////////////////////////////
  ...
  //      <COLUMN Name="Status"              StorageName="STATUS"               DataType="VARCHAR2" /> <COLUMN
  //      Name="ConfigurationString" StorageName="CONFIGURATION_STRING" DataType="VARCHAR2"/>
  //    </VIEW>
  //  </CONFIGURATION>
  //</ROOT>
}
...
const std::string ARTDAQConsumerConfiguration::getConfigurationString(std::string processorUID) const {
  ...
  ConfigurationBase::activeConfigurationView_->getValue(
      tmpConfiguration, ConfigurationBase::activeConfigurationView_->findRow(ProcessorID, processorUID),
      ConfigurationString);
