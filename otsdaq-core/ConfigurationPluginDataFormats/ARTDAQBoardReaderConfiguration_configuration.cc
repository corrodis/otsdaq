...
ARTDAQBoardReaderConfiguration::ARTDAQBoardReaderConfiguration(void)
    : TableBase("ARTDAQBoardReaderConfiguration")
{
	//////////////////////////////////////////////////////////////////////
...
void ARTDAQBoardReaderConfiguration::init(ConfigurationManager* configManager)
{
	...
	const XDAQContextConfiguration* contextConfig =
	    configManager->__GET_CONFIG__(XDAQContextConfiguration);
	...
	for(auto& readerContext : readerContexts)
	{
		...
		catch(const std::runtime_error& e)
		{
			...
			// the configuration group when the context is being developed also.
			//__SS_THROW__;
		}
	...
	for(auto& child : childrenMap)
	{
		...
		{
			__COUT_ERR__ << "Could not find matching context for this configuration!"
			             << std::endl;
		}
		else
		{
...
////========================================================================================================================
// void ARTDAQBoardReaderConfiguration::getBoardReaderParents(const ConfigurationTree
...
//========================================================================================================================
std::string ARTDAQBoardReaderConfiguration::getFHICLFilename(
...
//========================================================================================================================
void ARTDAQBoardReaderConfiguration::outputFHICL(
		...
		try
		{
			...
			for(auto& destination : destinations)
			{
				...
				OUT << destination.second.getNode("destinationKey").getValue() << ": {"
				    ...
				    << destination.second
				           .getNode("ARTDAQGlobalConfigurationLink/maxFragmentSizeWords")
