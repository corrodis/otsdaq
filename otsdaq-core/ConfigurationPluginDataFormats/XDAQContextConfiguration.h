...
class XDAQContextConfiguration : public ConfigurationBase {
 public:
  ...
  // void 								outputAppPriority		(std::ostream &out, const std::string&
  // stateMachineCommand);
  // void 								outputXDAQScript		(std::ostream
  // &out);
  // void 								outputARTDAQScript		(std::ostream
  // &out);
  ...
  ConfigurationTree getApplicationNode(const ConfigurationManager *configManager, const std::string &contextUID,
                                       const std::string &appUID) const;
  ConfigurationTree getSupervisorConfigNode(const ConfigurationManager *configManager, const std::string &contextUID,
                                            const std::string &appUID) const;
 ...
 public:
  static const std::set<std::string> FETypeClassNames_, DMTypeClassNames_, LogbookTypeClassNames_,
      MacroMakerTypeClassNames_, ChatTypeClassNames_, ConsoleTypeClassNames_, ConfigurationGUITypeClassNames_;
