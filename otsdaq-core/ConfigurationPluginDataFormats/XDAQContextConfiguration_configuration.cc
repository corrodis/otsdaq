...
const std::string XDAQContextConfiguration::GATEWAY_SUPERVISOR_CLASS =
    "ots::GatewaySupervisor";
const std::string XDAQContextConfiguration::WIZARD_SUPERVISOR_CLASS =
...
const std::set<std::string> XDAQContextConfiguration::DMTypeClassNames_ = {
    ...
    "ots::FEDataManagerSupervisor",
    "ots::ARTDAQFEDataManagerSupervisor"};
const std::set<std::string> XDAQContextConfiguration::LogbookTypeClassNames_ = {
    "ots::LogbookSupervisor"};
const std::set<std::string> XDAQContextConfiguration::MacroMakerTypeClassNames_ = {
    "ots::MacroMakerSupervisor"};
const std::set<std::string> XDAQContextConfiguration::ChatTypeClassNames_ = {
    "ots::ChatSupervisor"};
const std::set<std::string> XDAQContextConfiguration::ConsoleTypeClassNames_ = {
...
XDAQContextConfiguration::XDAQContextConfiguration(void)
    : TableBase("XDAQContextConfiguration")
{
	//////////////////////////////////////////////////////////////////////
	...
	// Name="XDAQContextConfiguration"> 	     <VIEW Name="XDAQ_CONTEXT_CONFIGURATION"
	...
	//           StorageName="LINK_TO_APPLICATION_CONFIGURATION" DataType="VARCHAR2"/>
...
unsigned int XDAQContextConfiguration::getARTDAQAppRank(
...
//========================================================================================================================
std::string XDAQContextConfiguration::getContextAddress(const std::string& contextUID,
                                                        bool               wantHttp) const
{
	if(contextUID == "X")
		return "";
...
unsigned int XDAQContextConfiguration::getARTDAQDataPort(
...
//========================================================================================================================
std::vector<const XDAQContextConfiguration::XDAQContext*>
XDAQContextConfiguration::getBoardReaderContexts() const
{
...
//========================================================================================================================
std::vector<const XDAQContextConfiguration::XDAQContext*>
XDAQContextConfiguration::getEventBuilderContexts() const
{
	std::vector<const XDAQContext*> retVec;
	for(auto& i : artdaqEventBuilders_)
		retVec.push_back(&contexts_[i]);
...
//========================================================================================================================
std::vector<const XDAQContextConfiguration::XDAQContext*>
XDAQContextConfiguration::getAggregatorContexts() const
{
	std::vector<const XDAQContext*> retVec;
	for(auto& i : artdaqAggregators_)
		retVec.push_back(&contexts_[i]);
...
//========================================================================================================================
ConfigurationTree XDAQContextConfiguration::getContextNode(
    const ConfigurationManager* configManager, const std::string& contextUID) const
{
...
//========================================================================================================================
ConfigurationTree XDAQContextConfiguration::getApplicationNode(
...
//========================================================================================================================
ConfigurationTree XDAQContextConfiguration::getSupervisorConfigNode(
    const ConfigurationManager* configManager,
    const std::string&          contextUID,
    const std::string&          appUID) const
{
...
//
////========================================================================================================================
// void XDAQContextConfiguration::outputAppPriority(std::ostream &out, const std::string&
// stateMachineCommand)
//{
...
//========================================================================================================================
std::string XDAQContextConfiguration::getApplicationUID(const std::string& url,
