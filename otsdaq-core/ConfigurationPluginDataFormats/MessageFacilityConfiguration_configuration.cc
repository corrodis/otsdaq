...
MessageFacilityConfiguration::MessageFacilityConfiguration(void)
    : TableBase("MessageFacilityConfiguration")
{
	//////////////////////////////////////////////////////////////////////
	...
	// Name="MessageFacilityConfiguration">
	//				<VIEW Name="MESSAGE_FACILITY_CONFIGURATION"
...
void MessageFacilityConfiguration::init(ConfigurationManager* configManager)
{
	...
	if(fs.fail())
	{
		__SS__ << "Failed to open Message Facility configuration file: " << MF_CFG_FILE
		       << std::endl;
		__SS_THROW__;
	}
	else
