...
//==============================================================================
xercesc::DOMNode* RegisterSequencerInfoReader::getNode(XMLCh* tagName, xercesc::DOMNode* parent,
                                                       unsigned int itemNumber) {
  return getNode(tagName, dynamic_cast<xercesc::DOMElement*>(parent), itemNumber);
}

//==============================================================================
xercesc::DOMNode* RegisterSequencerInfoReader::getNode(XMLCh* tagName, xercesc::DOMElement* parent,
                                                       unsigned int itemNumber) {
...
//==============================================================================
xercesc::DOMElement* RegisterSequencerInfoReader::getElement(XMLCh* tagName, xercesc::DOMNode* parent,
                                                             unsigned int itemNumber) {
  return dynamic_cast<xercesc::DOMElement*>(getNode(tagName, parent, itemNumber));
}

//==============================================================================
xercesc::DOMElement* RegisterSequencerInfoReader::getElement(XMLCh* tagName, xercesc::DOMElement* parent,
                                                             unsigned int itemNumber) {
  return dynamic_cast<xercesc::DOMElement*>(getNode(tagName, parent, itemNumber));
}
...
void RegisterSequencerInfoReader::read(RegisterBase& configuration) {
  /*
    ...
    configuration.getTypeName() + "RegisterSequencer/";
                //"/ConfigurationInfo/";
    ...
    DOMNode::ELEMENT_NODE )//true is not 0 && is element continue;

            configuration.getMockupViewP()->setName(XML_TO_CHAR(viewElement->getAttribute(viewNameAttributeTag_)));
            DOMElement * componentNameElement 	= dynamic_cast< xercesc::DOMElement*
    >(viewNodeList->getElementByTagName(typeNameTag_		)); DOMElement * registerNameElement 	= dynamic_cast<
    xercesc::DOMElement* >(viewNodeList->getElementByTagName(registerNameTag_	)); DOMElement * registerValueElement
    = dynamic_cast< xercesc::DOMElement* >(viewNodeList->getElementByTagName(registerValueTag_	)); DOMElement *
    sequenceNumberElement	= dynamic_cast< xercesc::DOMElement* >(viewNodeList->getElementByTagName(sequenceNumberTag_
    )); DOMElement * stateElement		 	= dynamic_cast< xercesc::DOMElement*
    >(viewNodeList->getElementByTagName(stateTag_			));
...
//==============================================================================
void RegisterSequencerInfoReader::read(RegisterBase* configuration) { read(*configuration); }
