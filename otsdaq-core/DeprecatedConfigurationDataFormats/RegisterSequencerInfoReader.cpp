...
//==============================================================================
xercesc::DOMNode* RegisterSequencerInfoReader::getNode(XMLCh*            tagName,
...
//==============================================================================
xercesc::DOMElement* RegisterSequencerInfoReader::getElement(XMLCh*            tagName,
                                                             xercesc::DOMNode* parent,
                                                             unsigned int      itemNumber)
{
...
void RegisterSequencerInfoReader::read(RegisterBase& configuration)
{
	...
	viewNodeList->item(view)->getNodeType() != DOMNode::ELEMENT_NODE )//true is not 0 &&
	is element continue;
	...
	>(viewNodeList->getElementByTagName(typeNameTag_		)); DOMElement *
	registerNameElement 	= dynamic_cast< xercesc::DOMElement*
	>(viewNodeList->getElementByTagName(registerNameTag_	)); DOMElement *
	registerValueElement 	= dynamic_cast< xercesc::DOMElement*
	>(viewNodeList->getElementByTagName(registerValueTag_	)); DOMElement *
	sequenceNumberElement	= dynamic_cast< xercesc::DOMElement*
	>(viewNodeList->getElementByTagName(sequenceNumberTag_	)); DOMElement * stateElement
	= dynamic_cast< xercesc::DOMElement* >(viewNodeList->getElementByTagName(stateTag_
	));
