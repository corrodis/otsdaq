...
class ViewRegisterSequencerInfo {
 public:
  ViewRegisterSequencerInfo(std::string componentName, std::string registerName, int registerValue, int sequenceNumber,
                            std::string state);
  //							  std::pair<int, int> initializeState, 		std::pair<int, int>
  //configurationState, 							  std::pair<int, int> startState,
  //std::pair<int, int> haltState,
  //							  std::pair<int, int> pauseState, 			std::pair<int, int>
  //resumeState);
