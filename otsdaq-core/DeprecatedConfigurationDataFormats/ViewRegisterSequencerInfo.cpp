...
ViewRegisterSequencerInfo::ViewRegisterSequencerInfo(std::string componentName, std::string registerName,
                                                     int registerValue, int sequenceNumber, std::string state)
...
//==============================================================================
const std::string& ViewRegisterSequencerInfo::getComponentName(void) const { return componentName_; }
//==============================================================================
const std::string& ViewRegisterSequencerInfo::getRegisterName(void) const { return registerName_; }
//==============================================================================
