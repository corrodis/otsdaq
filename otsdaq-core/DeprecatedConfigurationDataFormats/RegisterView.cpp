...
unsigned int RegisterView::findRow(unsigned int col, const std::string value) const {
  ...
  // std::cout << __COUT_HDR_FL__ << "\tIn view: " << name_ << " I Can't find " << value << " in column " << col << "
  // with name: " << registersInfo_[col].getName() << std::endl;
  assert(0);
  return 0;
}
...
// Getters
//==============================================================================
std::string RegisterView::getName(void) const { return name_; }

//==============================================================================
int RegisterView::getVersion(void) const { return version_; }

//==============================================================================
std::string RegisterView::getComment(void) const { return comment_; }

//==============================================================================
std::string RegisterView::getAuthor(void) const { return author_; }
//==============================================================================
time_t RegisterView::getCreationTime(void) const { return creationTime_; }
//==============================================================================
const std::vector<ViewRegisterInfo>& RegisterView::getRegistersInfo(void) const { return registersInfo_; }
//==============================================================================
std::vector<ViewRegisterInfo>* RegisterView::getRegistersInfoPointer(void) { return &registersInfo_; }
//==============================================================================
...
//==============================================================================
unsigned int RegisterView::getNumberOfRows(void) const { return theDataView_.size(); }
...
// Setters
//==============================================================================
void RegisterView::setName(std::string name) { name_ = name; }

//==============================================================================
void RegisterView::setVersion(int version) { version_ = version; }

//==============================================================================
void RegisterView::setVersion(char* version) { version_ = atoi(version); }

//==============================================================================
void RegisterView::setComment(std::string comment) { comment_ = comment; }

//==============================================================================
void RegisterView::setAuthor(std::string author) { author_ = author; }
//==============================================================================
void RegisterView::setCreationTime(time_t t) { creationTime_ = t; }
//==============================================================================
