...
unsigned int RegisterView::findRow(unsigned int col, const std::string value) const
{
	...
	// std::cout << __COUT_HDR_FL__ << "\tIn view: " << name_ << " I Can't find " << value
	// << " in column " << col << " with name: " << registersInfo_[col].getName() <<
	// std::endl;
	assert(0);
	return 0;
}
...
//==============================================================================
const std::vector<ViewRegisterSequencerInfo>& RegisterView::getRegistersSequencerInfo(
    void) const
{
	return registersSequencerInfo_;
}
//==============================================================================
std::vector<ViewRegisterSequencerInfo>* RegisterView::getRegistersSequencerInfoPointer(
    void)
{
	return &registersSequencerInfo_;
}
