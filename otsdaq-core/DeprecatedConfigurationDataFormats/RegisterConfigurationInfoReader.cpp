...
//==============================================================================
xercesc::DOMNode* RegisterConfigurationInfoReader::getNode(XMLCh* tagName, xercesc::DOMNode* parent,
                                                           unsigned int itemNumber) {
  return getNode(tagName, dynamic_cast<xercesc::DOMElement*>(parent), itemNumber);
}

//==============================================================================
xercesc::DOMNode* RegisterConfigurationInfoReader::getNode(XMLCh* tagName, xercesc::DOMElement* parent,
                                                           unsigned int itemNumber) {
  ...
  //        XML_TO_CHAR(nodeList->item(itemNumber)->getFirstChild()->getNodeValue()) << std::endl;
  return nodeList->item(itemNumber);
}

//==============================================================================
xercesc::DOMElement* RegisterConfigurationInfoReader::getElement(XMLCh* tagName, xercesc::DOMNode* parent,
                                                                 unsigned int itemNumber) {
  return dynamic_cast<xercesc::DOMElement*>(getNode(tagName, parent, itemNumber));
}

//==============================================================================
xercesc::DOMElement* RegisterConfigurationInfoReader::getElement(XMLCh* tagName, xercesc::DOMElement* parent,
                                                                 unsigned int itemNumber) {
  return dynamic_cast<xercesc::DOMElement*>(getNode(tagName, parent, itemNumber));
}
...
void RegisterConfigurationInfoReader::read(RegisterBase& configuration) {
  /*
    ...
    configuration.getTypeName() + "RegisterConfiguration/";
                //"/ConfigurationInfo/";
    std::string configFile = configurationDataDir + "/0/" + configuration.getTypeName() + "RegisterConfiguration" +
    ".xml"; struct stat fileStatus;
    ...
    XML_TO_CHAR(configurationElement->getAttribute(configurationNameAttributeTag_)) )
        {
            ...
            std::cout << __COUT_HDR_FL__ << "In " << configFile << " the configuration name " <<
    XML_TO_CHAR(configurationElement->getAttribute(configurationNameAttributeTag_))
        ...
        {
          if( !viewNodeList->item(view)->getNodeType() || viewNodeList->item(view)->getNodeType() !=
    xercesc::DOMNode::ELEMENT_NODE )//true is not 0 && is element continue;
    ...
    >(viewElement->getElementsByTagName(typeNameTag_		)->item(0)); xercesc::DOMElement * registerNameElement
    = dynamic_cast< xercesc::DOMElement* >(viewElement->getElementsByTagName(registerNameTag_	)->item(0));
            xercesc::DOMElement * baseAddressElement 	= dynamic_cast< xercesc::DOMElement*
    >(viewElement->getElementsByTagName(baseAddressTag_	)->item(0));
            xercesc::DOMElement * sizeElement		 	= dynamic_cast< xercesc::DOMElement*
    >(viewElement->getElementsByTagName(sizeTag_			)->item(0)); xercesc::DOMElement * accessElement
    = dynamic_cast< xercesc::DOMElement* >(viewElement->getElementsByTagName(accessTag_			)->item(0));
...
//==============================================================================
void RegisterConfigurationInfoReader::read(RegisterBase* configuration) { read(*configuration); }
