...
//==============================================================================
void Component::addRegister	(std::string name, std::string baseAddress, int size, std::string access, int globalSequencePosition, int globalValue)
{
  Register tempRegister_(name);
...
//==============================================================================
void Component::addRegister	(std::string name, std::string baseAddress, int size, std::string access, int initializeSequencePosition, 	int initializeValue, int configureSequencePosition,  	int configureValue)
{
  Register tempRegister_(name);
    tempRegister_.fillRegisterInfo( baseAddress, size, access);
	tempRegister_.setInitialize			(	  	std::make_pair(	  initializeSequencePosition,     initializeValue));
...
//==============================================================================
void Component::addRegister (std::string name, std::string baseAddress, int size, std::string access, int initializeSequencePosition, 	int initializeValue, int configureSequencePosition,	int configureValue, int startSequencePosition, int startValue, int haltSequencePosition, int haltValue, int pauseSequencePosition, int pauseValue, int resumeSequencePosition, int resumeValue)
{
  Register tempRegister_(name);
    tempRegister_.fillRegisterInfo( 	   baseAddress, 				       size, 		       access);
	tempRegister_.setInitialize			(	  	std::make_pair(	 initializeSequencePosition,     initializeValue));
...
//Getters
//==============================================================================
std::list<Register> Component::getRegisters(void){
	return registers_;
}
//==============================================================================
std::list<Register>* Component::getRegistersPointer(void){
	return &registers_;
}
//==============================================================================
...
//==============================================================================
std::string Component::getTypeName(void){
	return typeName_;
}
//==============================================================================
...
void Component::printInfo(void){
  ...
  std::cout << __COUT_HDR_FL__ << "===============================" << componentName_ << std::endl;
  std::cout << __COUT_HDR_FL__ << "==============================================================================" << std::endl;
  std::cout << __COUT_HDR_FL__ << "REGISTER \t\t BASE ADDRESS \t\t SIZE \t\t ACCESS \t\t||\t INIT \t CONFIG \t START \t STOP \t PAUSE \t RESUME " << std::endl;

	for(std::list<Register>::iterator aRegister = registers_.begin(); aRegister != registers_.end(); aRegister++)
	{
	  std::cout << __COUT_HDR_FL__ << aRegister->getName() << "\t\t" << aRegister->getBaseAddress() << "\t\t" << std::to_string(aRegister->getSize()) << "\t\t" << aRegister->getAccess() << "\t\t||\t" << printPair(aRegister->getInitialize()) << "/t" << printPair(aRegister->getStart()) << "\t" << printPair(aRegister->getHalt()) << "\t" << printPair(aRegister->getPause()) << "\t" << printPair(aRegister->getResume()) << std::endl;
	}
