...
class XmlDocument {
 public:
  ...
  xercesc::DOMElement* addTextElementToParent(std::string childName, std::string childText,
                                              xercesc::DOMElement* parent);
  xercesc::DOMElement* addTextElementToParent(std::string childName, std::string childText, std::string parentName,
                                              unsigned int parentIndex = 0);

  void saveXmlDocument(std::string filePath);
  void recursiveRemoveChild(xercesc::DOMElement* childEl,
                            xercesc::DOMElement* parentEl);  // remove entire element and sub tree, recursively
 ...
 protected:
  ...
  void recursiveOutputXmlDocument(xercesc::DOMElement* currEl, std::ostringstream* out, bool dispStdOut = false,
                                  std::string tabStr = "");

  //	unsigned int 	addElementToParent				(std::string field, std::string value, xercesc::DOMElement
  //*parentEl, bool verbose=false);
  //	void			recursiveAddElementToParent 	(xercesc::DOMElement *currEl, xercesc::DOMElement
  //*parentEl);
  //    std::string     recursiveFindElement            (xercesc::DOMElement *currEl, const std::string field, const
  //    unsigned int occurance, unsigned int &count); void            recursiveFindAllElements
  //    (xercesc::DOMElement *currEl, const std::string field,std::vector<std::string> *retVec);
