...
class HttpXmlDocument : public XmlDocument {
 public:
  ...
  xercesc::DOMElement *getMatchingElementInSubtree(xercesc::DOMElement *currEl, const std::string &field,
 ...
 private:
  ...
  void recursiveFindAllElements(xercesc::DOMElement *currEl, const std::string &field,
  ...
  void recursiveOutputXmlDocument(xercesc::DOMElement *currEl, std::ostringstream *out, bool dispStdOut = false,
                                  std::string tabStr = "", bool allowWhiteSpace = false);
  void recursiveFixTextFields(xercesc::DOMElement *currEl);
  std::string recursiveFindElementValue(xercesc::DOMElement *currEl, const std::string &field,
                                        const unsigned int occurance, unsigned int &count);
  xercesc::DOMElement *recursiveFindElement(xercesc::DOMElement *currEl, const std::string &field,
                                            const unsigned int occurance, unsigned int &count);
