...
#define XDAQ_RUN_FILE                                           \
	std::string(getenv("XDAQ_TABLE_DATA_PATH")) + "/" + \
	    std::string(getenv("XDAQ_TABLE_XML")) + ".xml"
#define APP_PRIORITY_FILE                                       \
	std::string(getenv("XDAQ_TABLE_DATA_PATH")) + "/" + \
	    "xdaqAppStateMachinePriority"

//#define XDAQ_SCRIPT				std::string(getenv("XDAQ_TABLE_DATA_PATH")) +
//"/"+ "StartXDAQ_gen.sh" #define ARTDAQ_MPI_SCRIPT
// std::string(getenv("XDAQ_TABLE_DATA_PATH")) + "/"+ "StartMPI_gen.sh"
