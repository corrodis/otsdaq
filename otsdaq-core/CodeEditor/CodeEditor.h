...
class CodeEditor {
 public:
  ...
  void xmlRequest(const std::string& option, cgicc::Cgicc& cgiIn, HttpXmlDocument* xmlOut);
 ...
 public:
  ...
  static void writeFile(const std::string& path, const std::string& contents, const unsigned long long& insertPos = -1,
