...
namespace FEWSupervisor 
{
	const std::string package     = "FEWSupervisor";
	const std::string versions    = MYPACKAGE_FULL_VERSION_LIST;
	const std::string summary     = "Front End Controllers supervisor";
	const std::string description = "Used to control the Front End with the detector";
