...
class CorePropertySupervisorBase {
 public:
  ...
  static void extractPermissionsMapFromString(const std::string& permissionsString,
                                              std::map<std::string, WebUsers::permissionLevel_t>& permissionsMap);
  static bool doPermissionsGrantAccess(std::map<std::string, WebUsers::permissionLevel_t>& permissionLevelsMap,
  ...
  ConfigurationTree getSupervisorConfigurationNode(void) const {
 ...
 protected:
  ...
  static const struct SupervisorProperties {
    SupervisorProperties()
        : allSetNames_({&CheckUserLockRequestTypes, &RequireUserLockRequestTypes, &AutomatedRequestTypes,
                        &AllowNoLoginRequestTypes, &NoXmlWhiteSpaceRequestTypes, &NonXMLRequestTypes}) {}
 ...
 private:
  ...
  struct CoreSupervisorPropertyStruct {
    CoreSupervisorPropertyStruct()
        : allSets_({&CheckUserLockRequestTypes, &RequireUserLockRequestTypes, &AutomatedRequestTypes,
                    &AllowNoLoginRequestTypes, &NoXmlWhiteSpaceRequestTypes, &NonXMLRequestTypes}) {}
