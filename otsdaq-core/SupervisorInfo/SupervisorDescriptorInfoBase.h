...
class SupervisorDescriptorInfoBase {
 ...
 protected:
  ...
  //    XDAQ_CONST_CALL xdaq::ApplicationDescriptor* getDataManagerDescriptor        (xdata::UnsignedIntegerT instance)
  //    const; XDAQ_CONST_CALL xdaq::ApplicationDescriptor* getFEDescriptor        	     (xdata::UnsignedIntegerT
  //    instance) const; XDAQ_CONST_CALL xdaq::ApplicationDescriptor* getDTCDescriptor
  //    (xdata::UnsignedIntegerT instance) const; XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
  ...
  //    XDAQ_CONST_CALL xdaq::ApplicationDescriptor* getARTDAQFEDataManagerDescriptor(xdata::UnsignedIntegerT instance)
  //    const; XDAQ_CONST_CALL xdaq::ApplicationDescriptor* getARTDAQDataManagerDescriptor  (xdata::UnsignedIntegerT
  //    instance) const; XDAQ_CONST_CALL xdaq::ApplicationDescriptor* getARTDAQBuilderDescriptor
  //    (xdata::UnsignedIntegerT instance) const; XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
  //    getARTDAQAggregatorDescriptor   (xdata::UnsignedIntegerT instance) const; XDAQ_CONST_CALL
  //    xdaq::ApplicationDescriptor* getVisualDescriptor   	         (xdata::UnsignedIntegerT instance) const;

  //   std::string 								getFEURL               (xdata::UnsignedIntegerT instance)
  //   const;
