...
void SupervisorDescriptorInfoBase::init(xdaq::ApplicationContext* applicationContext)
{
	...
	//*(applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::LogbookSupervisor").begin());
	//	if(theWizard_ == 0 && theLogbookSupervisor_ == 0)
	//		__COUT__ << "Note: Could not find xdaq application descriptor
	//\"ots::LogbookSupervisor\" (Must not be present in the xdaq context configuration)"
	//<< __E__;

	//	theDataManagerSupervisors_.clear();
	//	appDescriptors =
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::DataManagerSupervisor");
	//	for(auto& it: appDescriptors)
	//		theDataManagerSupervisors_[it->getLocalId()] = it;
	//	if(theWizard_ == 0 && theDataManagerSupervisors_.size() == 0)
	//		__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::DataManagerSupervisor\" (Must not be present in the xdaq context
	// configuration)" << __E__;

	//	//theFESupervisors_.clear();
	//	appDescriptors =
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::FESupervisor");
	//	for(auto& it: appDescriptors)
	//	{
	...
	//	__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::FESupervisor\" (Must not be present in the xdaq context configuration)" <<
	//__E__;

	// RAR: no need for this theDTCSupervisors_.. state machine should use 'all
	// supervisors'
	//    theDTCSupervisors_.clear();
	//    appDescriptors =
	//    applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("Ph2TkDAQ::DTCSupervisor");
	//    for(auto& it: appDescriptors)
	...
	//    {
	//        __COUT__ << "Note: Could not find any xdaq application descriptor
	//        \"ots::DTCSupervisor\" (Must not be present in the xdaq context
	//        configuration)" << __E__;
	//        //assert(0);
	//    }
	...
	//	appDescriptors =
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::FEDataManagerSupervisor");
	//	for(auto& it: appDescriptors)
	//	{
	...
	//	__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::FEDataManagerSupervisor\" (Must not be present in the xdaq context
	// configuration)" << __E__;

	//    theARTDAQFESupervisors_.clear();
	//    for(auto& it:
	//    applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::ARTDAQFESupervisor"))
	//    	theARTDAQFESupervisors_[it->getLocalId()] = it;
	//    if(theARTDAQFESupervisors_.size() == 0)
	//    {
	//        __COUT__ << "Note: Could not find xdaq application descriptor
	//        \"ots::ARTDAQFESupervisor\" (Must not be present in the xdaq context
	//        configuration)" << __E__;
	//        //assert(0);
	//    }
	//
	...
	//			for(auto& it:
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::ARTDAQFEDataManagerSupervisor"))
	//			{
	...
	//	__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::ARTDAQFEDataManagerSupervisor\" (Must not be present in the xdaq context
	// configuration)" << __E__;
	//
	//	theARTDAQDataManagerSupervisors_.clear();
	//	for(auto& it:
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::ARTDAQDataManagerSupervisor"))
	//		theARTDAQDataManagerSupervisors_[it->getLocalId()] = it;
	//	if(0)//theARTDAQDataManagerSupervisors_.size() == 0)
	//		__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::ARTDAQDataManagerSupervisor\" (Must not be present in the xdaq context
	// configuration)" << __E__;
	//
	//
	//	theARTDAQBuilderSupervisors_.clear();
	//	for(auto& it:
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::EventBuilderApp"))
	//		theARTDAQBuilderSupervisors_[it->getLocalId()] = it;
	//	if(0)//theARTDAQBuilderSupervisors_.size() == 0)
	//		__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::EventBuilderApp\" (Must not be present in the xdaq context configuration)" <<
	//__E__;
	//
	//
	//	theARTDAQAggregatorSupervisors_.clear();
	//	for(auto& it:
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::AggregatorApp"))
	//		theARTDAQAggregatorSupervisors_[it->getLocalId()] = it;
	//	if(0)//theARTDAQAggregatorSupervisors_.size() == 0)
	//		__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::AggregatorApp\" (Must not be present in the xdaq context configuration)" <<
	//__E__;
	//
	//
	//	theVisualSupervisors_.clear();
	//	for(auto& it:
	// applicationContext->getDefaultZone()->getApplicationGroup("daq")->getApplicationDescriptors("ots::VisualSupervisor"))
	//		theVisualSupervisors_[it->getLocalId()] = it;
	//	if(0)//theVisualSupervisors_.size() == 0)
	//		__COUT__ << "Note: Could not find any xdaq application descriptor
	//\"ots::VisualSupervisor\" (Must not be present in the xdaq context configuration)"
	//<< __E__;
}

//
////========================================================================================================================
// const SupervisorDescriptors&
// SupervisorDescriptorInfoBase::getDataManagerDescriptors(void) const
//{
...
//
////========================================================================================================================
// const SupervisorDescriptors& SupervisorDescriptorInfoBase::getDTCDescriptors(void)
// const
//{
...
////========================================================================================================================
// const SupervisorDescriptors&
// SupervisorDescriptorInfoBase::getFEDataManagerDescriptors(void) const
//{
//	return theFEDataManagerSupervisors_;
//}

//========================================================================================================================
// const SupervisorDescriptors& SupervisorDescriptorInfoBase::getARTDAQFEDescriptors(void)
// const
//{
...
////========================================================================================================================
// const SupervisorDescriptors&
// SupervisorDescriptorInfoBase::getARTDAQFEDataManagerDescriptors(void) const
//{
//	return theARTDAQFEDataManagerSupervisors_;
//}
////========================================================================================================================
// const SupervisorDescriptors&
// SupervisorDescriptorInfoBase::getARTDAQDataManagerDescriptors  (void) const
//{
...
////========================================================================================================================
// const SupervisorDescriptors&
// SupervisorDescriptorInfoBase::getARTDAQBuilderDescriptors(void) const
//{
...
////========================================================================================================================
// const SupervisorDescriptors&
// SupervisorDescriptorInfoBase::getARTDAQAggregatorDescriptors(void) const
//{
//	return theARTDAQAggregatorSupervisors_;
//}
//
////========================================================================================================================
// const SupervisorDescriptors& SupervisorDescriptorInfoBase::getVisualDescriptors(void)
// const
//{
...
//
////========================================================================================================================
// const SupervisorDescriptors& SupervisorDescriptorInfoBase::getAllFEDescriptors(void)
// const
//{
...
// SupervisorDescriptorInfoBase::getSupervisorDescriptor(void) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getWizardDescriptor(void) const
//{
//	return theWizard_;
//}
//
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getLogbookDescriptor(void) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getVisualDescriptor(xdata::UnsignedIntegerT instance)
// const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getDataManagerDescriptor(xdata::UnsignedIntegerT
// instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getFEDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getDTCDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getFEDataManagerDescriptor(xdata::UnsignedIntegerT
// instance) const
//{
...
//========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQFEDescriptor(xdata::UnsignedIntegerT instance)
// const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQFEDataManagerDescriptor(xdata::UnsignedIntegerT
// instance) const
//{
//	if(theARTDAQFEDataManagerSupervisors_.find(instance) ==
// theARTDAQFEDataManagerSupervisors_.end())
//		__COUT__ << "Could not find: " << instance << __E__;
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQDataManagerDescriptor  (xdata::UnsignedIntegerT
// instance) const
//{
//	if(theARTDAQDataManagerSupervisors_.find(instance) ==
// theARTDAQDataManagerSupervisors_.end())
//		__COUT__ << "Could not find: " << instance << __E__;
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQBuilderDescriptor(xdata::UnsignedIntegerT
// instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQAggregatorDescriptor(xdata::UnsignedIntegerT
// instance) const
//{
//	if(theARTDAQAggregatorSupervisors_.find(instance) ==
// theARTDAQAggregatorSupervisors_.end())
//		__COUT__ << "Could not find: " << instance << __E__;
//	return  theARTDAQAggregatorSupervisors_.find(instance)->second;
//}
//
////========================================================================================================================
// std::string SupervisorDescriptorInfoBase::getFEURL(xdata::UnsignedIntegerT instance)
// const
//{
...
/*
//========================================================================================================================
std::string SupervisorDescriptorInfoBase::getARTDAQFEURL(xdata::UnsignedIntegerT instance)
const
{
...
//========================================================================================================================
std::string SupervisorDescriptorInfoBase::getARTDAQBuilderURL(xdata::UnsignedIntegerT
instance) const
{
...
//========================================================================================================================
std::string SupervisorDescriptorInfoBase::getARTDAQAggregatorURL(xdata::UnsignedIntegerT
instance) const
{
