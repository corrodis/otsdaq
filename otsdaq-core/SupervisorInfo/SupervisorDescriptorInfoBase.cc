...
void SupervisorDescriptorInfoBase::init(xdaq::ApplicationContext* applicationContext) {
  if (applicationContext->getDefaultZone()->getApplicationGroup("daq") == 0) {
    __SS__ << "Could not find xdaq application group \"daq\" (Must not be present in the xdaq context configuration)"
           << __E__;
    __SS_THROW__;
  }
  ...
  //		__COUT__ << "Note: Could not find xdaq application descriptor \"ots::Supervisor\" (Must not be present in
  //the xdaq context configuration)" << __E__;
  //
  //	theWizard_ =
  ...
  //	if(0)//theWizard_ == 0)
  //		__COUT__ << "Note: Could not find xdaq application descriptor \"ots::OtsConfigurationWizardSupervisor\"
  //(Must not be present in the xdaq context configuration)" << __E__;
  //
  //	if(theWizard_ == 0 && theSupervisor_ == 0)
  //	{
  //		__SS__ << "Must have THE ots::Supervisor (or THE ots::OtsConfigurationWizardSupervisor) as part of the
  //context configuration!" << __E__;
  //		__COUT_ERR__ << "\n" << ss.str();
  //		__SS_THROW__;
  //	}
  ...
  for (auto& it : appDescriptors) {
    auto /*<it,bool*/ retPair = allSupervisors_.emplace(
        std::pair<xdata::UnsignedIntegerT, XDAQ_CONST_CALL xdaq::ApplicationDescriptor*>(it->getLocalId(), it));
    if (!retPair.second) {
  ...
  //		__COUT__ << "Note: Could not find xdaq application descriptor \"ots::LogbookSupervisor\" (Must not be
  //present in the xdaq context configuration)" << __E__;
  ...
  //		__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::DataManagerSupervisor\" (Must not
  //be present in the xdaq context configuration)" << __E__;
  ...
  //	__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::FESupervisor\" (Must not be present in
  //the xdaq context configuration)" << __E__;
  ...
  //    {
  //        __COUT__ << "Note: Could not find any xdaq application descriptor \"ots::DTCSupervisor\" (Must not be
  //        present in the xdaq context configuration)" << __E__;
  //        //assert(0);
  //    }
  ...
  //	__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::FEDataManagerSupervisor\" (Must not be
  //present in the xdaq context configuration)" << __E__;
  ...
  //    {
  //        __COUT__ << "Note: Could not find xdaq application descriptor \"ots::ARTDAQFESupervisor\" (Must not be
  //        present in the xdaq context configuration)" << __E__;
  //        //assert(0);
  //    }
  //
  ...
  //	__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::ARTDAQFEDataManagerSupervisor\" (Must
  //not be present in the xdaq context configuration)" << __E__;
  //
  ...
  //		__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::ARTDAQDataManagerSupervisor\" (Must
  //not be present in the xdaq context configuration)" << __E__;
  //
  //
  ...
  //		__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::EventBuilderApp\" (Must not be
  //present in the xdaq context configuration)" << __E__;
  //
  //
  ...
  //		__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::AggregatorApp\" (Must not be
  //present in the xdaq context configuration)" << __E__;
  //
  //
  ...
  //		__COUT__ << "Note: Could not find any xdaq application descriptor \"ots::VisualSupervisor\" (Must not be
  //present in the xdaq context configuration)" << __E__;
}
...
// SupervisorDescriptorInfoBase::getVisualDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getDataManagerDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
//
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor* SupervisorDescriptorInfoBase::getFEDescriptor(xdata::UnsignedIntegerT
// instance) const
//{
...
//
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor* SupervisorDescriptorInfoBase::getDTCDescriptor(xdata::UnsignedIntegerT
// instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getFEDataManagerDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
//========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQFEDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQFEDataManagerDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
//
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor* SupervisorDescriptorInfoBase::getARTDAQDataManagerDescriptor
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQBuilderDescriptor(xdata::UnsignedIntegerT instance) const
//{
...
////========================================================================================================================
// XDAQ_CONST_CALL xdaq::ApplicationDescriptor*
// SupervisorDescriptorInfoBase::getARTDAQAggregatorDescriptor(xdata::UnsignedIntegerT instance) const
//{
