...
void AllSupervisorInfo::init (xdaq::ApplicationContext* applicationContext)
{
	...
	{
		__SS__ << "Error! Must have one " << XDAQContextConfiguration::GATEWAY_SUPERVISOR_CLASS << " OR one " << XDAQContextConfiguration::WIZARD_SUPERVISOR_CLASS << " as part of the context configuration! "
...
const SupervisorInfo& AllSupervisorInfo::getGatewayInfo (void) const
{
	if (!theSupervisorInfo_)
	{
		__SS__ << "AllSupervisorInfo was not initialized or no Application of type " << XDAQContextConfiguration::GATEWAY_SUPERVISOR_CLASS << " found!" << __E__;
		__SS_THROW__;
	}
...
const SupervisorInfo& AllSupervisorInfo::getWizardInfo (void) const
{
	if (!theWizardInfo_)
	{
		__SS__ << "AllSupervisorInfo was not initialized or no Application of type " << XDAQContextConfiguration::WIZARD_SUPERVISOR_CLASS << "  found!" << __E__;
		__SS_THROW__;
	}
