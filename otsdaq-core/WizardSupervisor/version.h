#ifndef _ots_WizardSupervisor_version_h_
#define _ots_WizardSupervisor_version_h_
...
const std::string description =
    "The Wizard Supervisor is the primary server for otsdaq wiz mode through which all user requests are handled.";
