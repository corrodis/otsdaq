...
class Iterator {
 ...
 private:
  ...
  volatile bool commandPlay_, commandPause_,
      commandHalt_;  // commands are set by supervisor thread, and cleared by iterator thread
  ...
  static void helpCommandModifyActive(IteratorWorkLoopStruct *iteratorStruct, const T &setValue,
