...
#define DEFINE_OTS_PROCESSOR(klass)                                                                                \
  extern "C" ots::DataProcessor* make(std::string const& supervisorApplicationUID, std::string const& bufferUID,   \
                                      std::string const& processorUID, const ConfigurationTree& configurationTree, \
                                      const std::string& pathToInterfaceConfiguration) {                           \
    return new klass(supervisorApplicationUID, bufferUID, processorUID, configurationTree,                         \
