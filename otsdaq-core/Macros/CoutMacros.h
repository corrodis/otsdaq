...
#define __CFG_COUT_TYPE__(X)                                                             \
	std::cout << QUOTE(X) << ":" << __MF_SUBJECT__ << ":" << theConfigurationRecordName_ \
	          << ":"
#define __CFG_MF_TYPE__(X) \
	mf::X(std::string(__MF_SUBJECT__) + "-" + theConfigurationRecordName_)
...
#define __CFG_SS__                                                           \
	std::stringstream ss;                                                    \
	ss << ":" << __MF_SUBJECT__ << ":" << theConfigurationRecordName_ << ":" \
	   << __COUT_HDR__
...
#define __FE_MF_TYPE__(X)                                                           \
	mf::X(std::string("FE-") + getInterfaceType() + "-" + getInterfaceUID() + "-" + \
	      theConfigurationRecordName_)
...
#define __FE_SS__                                                         \
	std::stringstream ss;                                                 \
	ss << ":FE:" << getInterfaceType() << ":" << getInterfaceUID() << ":" \
	   << theConfigurationRecordName_ << ":" << __COUT_HDR__
