 ...
 * ----------------------------------------------------------------------
     ...
     line #   function-name                    file-name        date        time    user-cout arguments
     34    ] [int main(int argc, cha**argv))] [example.cc] [Jun 22 2018] [10:13:54] Result is 1.2
    
     The following name-spaced variables control the actual output produced:
      
     int	 DMM::__span__	          : controls the width of the function/file name field (number of character)s
     int         DMM::__pthr__	     	  : controls the priority level: only cout statements declared with an equal 
                                            or above level with respect to the current value of the DMM::__pthr__ will
					    be printed out
     bool	 DMM::__enablePrintouts__ : switches of the following cout statment (does not produce output
     bool	 DMM::__long__	          : shortens the name of the function (removes signature if false)
     bool	 DMM::__meth__	     	  : enables/disables output of the function-name field
     bool	 DMM::__file__	     	  : enables/disables output of the file-name field
     bool	 DMM::__date__	     	  : enables/disables output of the date field
     bool	 DMM::__time__	     	  : enables/disables output of the time field 
     std::string DMM::__c_meth__	  : determines the color of the function-name field
     ...
     int main(int argc, char** argv) 
     {
      ...
      __PRE__(0,{cout << "A: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s 
     		    << " --------------------------------------------------------------"
     		    << endl ;})
      __PRE__(3,{cout << "B: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ;})
      DMM::__enablePrintouts__ = false ;
      __PRE__(0,{cout << "C: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ;})
      DMM::__enablePrintouts__ = true ;
      __PRE__(0,{cout << "D: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ;})
      DMM::__long__ = true ; DMM::__file__ = true ;
      __PRE__(0,{cout << "E: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ;})
      DMM::__c_meth__ = ACBGreen_;
      __PRE__(0,{cout << "F: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ;})
      DMM::__c_meth__ = ACBGreen_ + ACReverse_;
      DMM::__meth__ = false ; DMM::__file__ = false ; DMM::__date__ = true ; DMM::__time__ = true  ;
      __PRE__(0,{cout << "G: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ;})
      DMM::__meth__ = false ; DMM::__file__ = true ; DMM::__date__ = false ; DMM::__time__ = false ;
      __PRE__(0,{cout << "H: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ;})
      DMM::__meth__ = true  ; DMM::__file__ = true ; DMM::__date__ = true  ; DMM::__time__ = true  ;
      DMM::__c_file__ = ACBBrown_ + ACReverse_;
      __PRE0__(   cout << "I: " << i << " " << ACBCyan_ << d << ACPlain_ << " " << s << endl ; )
     }
...
40	] [main                                ] B: 5 4.6 Just a regular string
44	] [main                                ] D: 5 4.6 Just a regular string
46	] [int main(int, char**)               ] [main.cc                             ] E: 5 4.6 Just a regular string
48	] [int main(int, char**)               ] [main.cc                             ] F: 5 4.6 Just a regular string
51	] [Jun 22 2018] [13:32:26] G: 5 4.6 Just a regular string
53	] [main.cc                             ] H: 5 4.6 Just a regular string
56	] [int main(int, char**)               ] [main.cc                             ] [Jun 22 2018] [13:32:26] I: 5 4.6 Just a regular string

      To see color, type: more DMMacros.h
       
[0;36m[1m17[0m[1;33m	] [0m[1;33m[[1;35m[1msomeClassWithAVeryLongName::so[0;31m...   [0m[1;33m] [0m1 [0;31m[1mCtor
[0;36m[1m23[0m[1;33m	] [0m[1;33m[[1;35m[1mdoSomethingInThisClass           [0m[0m[0m   [0m[1;33m] [0m2 [1;32m[1mdo whatever needs to be done
[0;36m[1m39[0m[1;33m	] [0m[1;33m[[1;35m[1mmain                             [0m[0m[0m   [0m[1;33m] [0mA: 5 [0;36m[1m4.6[0m Just a regular string --------------------------------------------------------------
[0;36m[1m40[0m[1;33m	] [0m[1;33m[[1;35m[1mmain                             [0m[0m[0m   [0m[1;33m] [0mB: 5 [0;36m[1m4.6[0m Just a regular string
[0;36m[1m44[0m[1;33m	] [0m[1;33m[[1;35m[1mmain                             [0m[0m[0m   [0m[1;33m] [0mD: 5 [0;36m[1m4.6[0m Just a regular string
[0;36m[1m46[0m[1;33m	] [0m[1;33m[[1;35m[1mint main(int, char**)            [0m[0m[0m   [0m[1;33m] [0m[1;33m[[0;36m[1mmain.cc                          [0m[0m[0m   [0m[1;33m] [0mE: 5 [0;36m[1m4.6[0m Just a regular string
[0;36m[1m48[0m[1;33m	] [0m[1;33m[[0;32m[1mint main(int, char**)            [0m[0m[0m   [0m[1;33m] [0m[1;33m[[0;36m[1mmain.cc                          [0m[0m[0m   [0m[1;33m] [0mF: 5 [0;36m[1m4.6[0m Just a regular string
[0;36m[1m51[0m[1;33m	] [0m[1;33m[[1;36m[1mJun 22 2018[0m[1;33m] [0m[1;33m[[1;34m[1m13:44:32[0m[1;33m] [0mG: 5 [0;36m[1m4.6[0m Just a regular string
[0;36m[1m53[0m[1;33m	] [0m[1;33m[[0;36m[1mmain.cc                          [0m[0m[0m   [0m[1;33m] [0mH: 5 [0;36m[1m4.6[0m Just a regular string
[0;36m[1m56[0m[1;33m	] [0m[1;33m[[0;32m[1m[7mint main(int, char**)            [0m[0m[0m   [0m[1;33m] [0m[1;33m[[0;33m[1m[7mmain.cc                          [0m[0m[0m   [0m[1;33m] [0m[1;33m[[1;36m[1mJun 22 2018[0m[1;33m] [0m[1;33m[[1;34m[1m13:44:32[0m[1;33m] [0mI: 5 [0;36m[1m4.6[0m Just a regular string
 */
