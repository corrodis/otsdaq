...
class ConfigurationBase {
 public:
  ...
  ConfigurationVersion checkForDuplicate(ConfigurationVersion needleVersion,
                                         ConfigurationVersion ignoreVersion = ConfigurationVersion()) const;
  ...
  ConfigurationVersion copyView(const ConfigurationView &sourceView, ConfigurationVersion destinationVersion,
                                const std::string &author);
  ConfigurationVersion mergeViews(
  ...
  ConfigurationVersion createTemporaryView(
      ConfigurationVersion sourceViewVersion = ConfigurationVersion(),
      ConfigurationVersion destTemporaryViewVersion =
          ConfigurationVersion::getNextTemporaryVersion());  // source of -1, from MockUp, else from valid view version
