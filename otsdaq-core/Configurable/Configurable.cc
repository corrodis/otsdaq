...
//==============================================================================
ConfigurationTree Configurable::getSelfNode() const { return theXDAQContextConfigTree_.getNode(theConfigurationPath_); }
...
unsigned int Configurable::getApplicationLID() const {
  const XDAQContextConfiguration* contextConfig = getConfigurationManager()->__GET_CONFIG__(XDAQContextConfiguration);
