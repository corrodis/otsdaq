...
class ConfigurationManager {
 ...
 public:
  ...
  void loadConfigurationGroup(const std::string &configGroupName, ConfigurationGroupKey configGroupKey,
                              bool doActivate = false, std::map<std::string, ConfigurationVersion> *groupMembers = 0,
                              ProgressBar *progressBar = 0, std::string *accumulateWarnings = 0,
                              std::string *groupComment = 0, std::string *groupAuthor = 0,
                              std::string *groupCreateTime = 0, bool doNotLoadMember = false,
  ...
  std::map<std::string /*tableName*/, std::map<std::string /*aliasName*/, ConfigurationVersion>> getVersionAliases(
      void) const;

  std::pair<std::string /*groupName*/, ConfigurationGroupKey> getConfigurationGroupFromAlias(
      std::string systemAlias, ProgressBar *progressBar = 0);
  std::map<std::string /*groupType*/, std::pair<std::string /*groupName*/, ConfigurationGroupKey>>
  getActiveConfigurationGroups(void) const;
  const std::map<std::string /*groupType*/, std::pair<std::string /*groupName*/, ConfigurationGroupKey>>
  ...
  ConfigurationTree getNode(const std::string &nodeString,
  ...
  ConfigurationTree getSupervisorConfigurationNode(const std::string &contextUID,
                                                   const std::string &applicationUID) const;

  std::vector<std::pair<std::string /*childName*/, ConfigurationTree>> getChildren(
      std::map<std::string, ConfigurationVersion> *memberMap = 0, std::string *accumulatedTreeErrors = 0) const;
