...
class DatabaseConfigurationInterface : public ConfigurationInterface {
 public:
  ...
  std::set<std::string /*name+version*/> getAllConfigurationGroupNames(const std::string& filterString = "") const
      throw(std::runtime_error);
  ...
  config_version_map_t getConfigurationGroupMembers(std::string const& /*configurationGroup*/,
